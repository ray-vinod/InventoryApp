    ...
    public partial class UserIndex : ComponentBase
    {
        ...
        private async Task LoadUser()
        {
            foreach (var user in UserManager.Users)
            {
                ...
                {
                    Id = user.Id,
                    FullName = $"{user.FName} {(user.MName != null ? user.MName : null)} {user.LName}",
                    Email = user.UserName,
        ...
        private async Task AddRemoveRole(UserViewModel user)
        {
            ...
            parameter.Add(nameof(AddEditRoleModal.UserName), user.FullName);
            parameter.Add(nameof(AddEditRoleModal.Roles), user.Roles);
            ...
            var dialog = Modal.Show<AddEditRoleModal>("", parameter, options);
